...
public class level2 extends game {
    ...
    public level2() {
        ...
        //assigning img in array.
            ...
            //int delay = 1000;
           // Timer timer;
            //timer = new Timer(1000, lbltime.setText(timer));
            lbmoves.setText("Moves: "+ moves );
    ...
    public int CheckAll() {
           ...
           for (int aaa = 0; aaa <=7; aaa++)
            {
                for (int bbb = 0; bbb <=4; bbb++)
                {
                    ...
                    {
                        if(arr1[aaa][bbb+2] ==arr1[aaa][bbb+3])
                        {
     ...
     public void Down_Slide(int i,int j)
       ...
       {
           if( moves == 10)
           {    JOptionPane.showMessageDialog(null, " Compeleted Leve2 \n your score is "+ score1);
    ...
    private void initComponents() {
        ...
        lblscore1.setFont(new java.awt.Font("Raavi", 3, 24)); // NOI18N
        lblscore1.setText("jLabel1");

        lbmoves.setFont(new java.awt.Font("Raavi", 3, 24)); // NOI18N
        lbmoves.setText("jLabel1");

        lblname.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pics/name.png"))); // NOI18N
        lblname.setText("jLabel1");

        btnmenu.setBackground(new java.awt.Color(255, 102, 0));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(lbmoves, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(lblscore1, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(35, 35, 35)
